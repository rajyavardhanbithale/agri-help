...
export default function Search() {
    ...
    const handleFetch = async (category) => {
        ...
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_API_ENDPOINT}/rental-item?item=95&category=${category}`);
    ...
    const category = ["machinery", "tools", "equipment", "agriculture"]
                            ...
                            <div key={idx} className="px-2 pb-4 md:px-5">
                                ...
                                >
                                    <div className="flex flex-col">
                                        ...
                                        <div>
                                            <p className="mt-2 text-xl  overflow-hidden">{product?.name}</p>
